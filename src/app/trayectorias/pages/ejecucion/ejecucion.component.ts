...
export class EjecucionComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataService.getJson('https://filecdfv3.s3.amazonaws.com/DatosJson_100.json').pipe().subscribe(response => {
    ...
    this.dataService.getMapa('https://filecdfv3.s3.amazonaws.com/MapaPrueba_100').pipe().subscribe(response => {
      this.mapa = response;
    ...
    this.dataService.getMapa('https://filecdfv3.s3.amazonaws.com/Mensaje_169.txt').pipe().subscribe(response => {
