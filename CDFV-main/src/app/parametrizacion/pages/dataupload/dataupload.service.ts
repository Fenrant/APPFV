...
export class PruebaService {
    ...
    async uploadFile2(file: any, filePath: any) {
      ...
      return new Promise((resolve, reject) => {
        ...
        const bucket = new S3({
          accessKeyId: 'AKIARLL2KP7KZZZ2PQUN',// ACCESS_KEY_ID
          secretAccessKey: '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',// SECRET_ACCESS_KEY
          region: 'us-west-1',// BUCKET_REGION
        });
        const params = {
          Bucket: 'filecdfv',//BUCKET_NAME
          Key: filePath,
          Body: file,
          ACL: 'public-read',
